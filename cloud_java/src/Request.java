...
public class Request implements org.apache.thrift.TBase<Request, Request._Fields>, java.io.Serializable, Cloneable, Comparable<Request> {
  ...
  private static final org.apache.thrift.protocol.TField SIGNATURES_FIELD_DESC = new org.apache.thrift.protocol.TField("signatures", org.apache.thrift.protocol.TType.LIST, (short)2);
  ...
  public List<Signature> signatures; // required
  ...
  public Request(Request other) {
    ...
    if (other.isSetSignatures()) {
      List<Signature> __this__signatures = new ArrayList<Signature>(other.signatures.size());
      for (Signature other_element : other.signatures) {
        __this__signatures.add(new Signature(other_element));
      }
  ...
  public java.util.Iterator<Signature> getSignaturesIterator() {
    return (this.signatures == null) ? null : this.signatures.iterator();
  }

  public void addToSignatures(Signature elem) {
  ...
  public Request setSignatures(List<Signature> signatures) {
    this.signatures = signatures;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.signatures = new ArrayList<Signature>(_list8.size);
                Signature _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new Signature();
                  _elem9.read(iprot);
                  struct.signatures.add(_elem9);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Request struct) throws org.apache.thrift.TException {
      ...
      if (struct.signatures != null) {
        oprot.writeFieldBegin(SIGNATURES_FIELD_DESC);
        {
          ...
          for (Signature _iter11 : struct.signatures)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetSignatures()) {
        {
          ...
          for (Signature _iter12 : struct.signatures)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.signatures = new ArrayList<Signature>(_list13.size);
          Signature _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new Signature();
            _elem14.read(iprot);
            struct.signatures.add(_elem14);
          }
        }
        struct.setSignaturesIsSet(true);
      }
